...
- [ ] 2. Database schema and Row Level Security
  ...
  - [ ] 2.2 Write migrations for game, quiz, calendar, and notification tables
  ...
  - [ ] 2.3 Implement RLS policies and Storage bucket policies
...
- [ ] 3. Authentication domain logic (pure helpers)
  ...
  - [ ] 3.2 Write property test for password policy
  ...
  - [ ] 3.7 Write property test for single active session invariant
    - **Property 8: Single active session invariant**
    - **Validates: Requirements 2.5, 2.7, 2.8, 2.9**

  - [ ] 3.8 Write property test for session inactivity expiry
    - **Property 9: Session inactivity expiry**
    - **Validates: Requirements 2.6**

- [ ] 4. Sync domain logic (HLC and offline queue)
  ...
  - [ ] 4.4 Write property test for offline queue integrity
    - **Property 17: Offline changes are queued without loss**
    - **Validates: Requirements 5.4**

- [ ] 5. Real-time game engine logic (pure)
  - [ ] 5.1 Implement applyMove engine and concrete game rulesets
  ...
  - [ ] 5.2 Write property test for the move engine
    - **Property 20: Real-time move engine correctness**
    - **Validates: Requirements 6.4, 6.11**

  - [ ] 5.3 Implement join transition, pause/rejoin, and terminal-outcome state logic
  ...
  - [ ] 5.4 Write property test for join transition
    - **Property 22: Real-time join transition produces identical active state**
    - **Validates: Requirements 6.3**

  - [ ] 5.5 Write property test for pause/rejoin state preservation
    - **Property 21: Pause preserves and rejoin restores real-time state**
    - **Validates: Requirements 6.6, 6.7**

  - [ ] 5.6 Write property test for terminal outcome
    - **Property 23: Real-time terminal outcome is recorded and presented**
    - **Validates: Requirements 6.8**

- [ ] 6. Asynchronous game engine logic (pure)
  - [ ] 6.1 Implement applyTurn engine and concrete rulesets
  ...
  - [ ] 6.2 Write property test for the turn engine
    - **Property 24: Asynchronous turn engine correctness**
    - **Validates: Requirements 7.4, 7.5, 7.7, 7.8**

  - [ ] 6.3 Implement inactivity/nudge and turn-handoff notification derivation
  ...
  - [ ] 6.4 Write property test for persistence through inactivity
    - **Property 25: Asynchronous session persists through inactivity**
    - **Validates: Requirements 7.11, 7.12**

  - [ ] 6.5 Write property test for turn hand-off notification
    - **Property 41: Turn hand-off notification**
    - **Validates: Requirements 7.6**

- [ ] 7. Quiz domain logic (pure)
  - [ ] 7.1 Implement answer validation and scoring helpers
  ...
  - [ ] 7.2 Write property test for answer/guess validation
  ...
  - [ ] 7.3 Write property test for scoring
    - **Property 31: Quiz scoring matches per answer type**
    - **Validates: Requirements 8.7**

  - [ ] 7.4 Implement quiz session state machine, catalog integrity, and self-answer view redaction
  ...
  - [ ] 7.5 Write property test for initial quiz state
    - **Property 26: Quiz session initial state**
    - **Validates: Requirements 8.2**

  - [ ] 7.6 Write property test for single active quiz session
    - **Property 27: Only one active quiz session per pairing**
    - **Validates: Requirements 8.11**

  - [ ] 7.7 Write property test for phase progression
    - **Property 30: Quiz phase progression**
    - **Validates: Requirements 8.5, 8.8**

  - [ ] 7.8 Write property test for self-answer withholding in the serialized view
    - **Property 28: Quiz self-answers are withheld during the self-answer phase**
    - **Validates: Requirements 8.4**

  - [ ] 7.9 Write property test for question-to-quiz uniqueness
    - **Property 32: Each quiz question belongs to exactly one quiz**
    - **Validates: Requirements 8.9**

- [ ] 8. Calendar and reminder domain logic (pure)
  - [ ] 8.1 Implement date and reminder helpers
  ...
  - [ ] 8.2 Write property test for date validation
    - **Property 34: Relationship date validation**
    - **Validates: Requirements 9.4, 9.5, 9.6**

  - [ ] 8.3 Write property test for date ordering
    - **Property 35: Relationship date ordering**
    - **Validates: Requirements 9.7**

  - [ ] 8.4 Write property test for reminder scheduling/validation
    - **Property 36: Reminder scheduling and validation**
    - **Validates: Requirements 10.1, 10.2** (exercise 1-minute and 365-day boundaries)

  - [ ] 8.5 Implement date persistence model, cascade cancel, and recurring reschedule
  ...
  - [ ] 8.6 Write property test for date persistence round-trip
    - **Property 33: Relationship date persistence round-trip**
    - **Validates: Requirements 9.1, 9.2, 9.3**

  - [ ] 8.7 Write property test for delete cancels reminders
    - **Property 37: Deleting a date cancels its reminders**
    - **Validates: Requirements 10.4**

  - [ ] 8.8 Write property test for recurring reminder reschedule
    - **Property 38: Recurring reminders reschedule on delivery**
    - **Validates: Requirements 10.5**

- [ ] 9. Notification domain logic (pure)
  - [ ] 9.1 Implement delivery eligibility helpers
  ...
  - [ ] 9.2 Write property test for notification delivery eligibility
    - **Property 39: Notification delivery eligibility**
    - **Validates: Requirements 11.3, 11.4, 11.5, 11.6**

- [ ] 10. Pairing domain logic (pure)
  - [ ] 10.1 Implement invitation, exclusivity, acceptance, dissolution, and require-pairing logic
...
- [ ] 12. Authentication Edge Functions and single-session enforcement
  ...
  - [ ] 12.2 Implement login epoch hook, epoch guard, and revoke signal
  ...
  - [ ] 12.3 Implement lockout recording and inactivity handling
...
- [ ] 13. Pairing Edge Functions
  - [ ] 13.1 Implement createInvitation and acceptInvitation
